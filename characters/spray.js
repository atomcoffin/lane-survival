/* SPRAY — edit the display name and dialogue, then refresh the browser.
...
window.LS_CHARACTERS.SPRAY = {
  name: "SPRAY",
  idle: ["spray n pray", "pump it", "eat lead", "spread out"],
  hurt: ["winged me!", "ow, pellets", "reloading"],
  ult:  ["FULL CHOKE!", "point blank"]
};
