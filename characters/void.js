/* VOID — edit the display name and dialogue, then refresh the browser.
...
window.LS_CHARACTERS.VOID = {
  name: "VOID",
  idle: ["into the void", "goodbye", "gravity sux", "stare deep"],
  hurt: ["spaghetti'd!", "my event!", "ow, dense"],
  ult:  ["EVENT HORIZON!", "no escape"]
};
